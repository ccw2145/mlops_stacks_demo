...
```
mlops_stacks_demo        <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_stacks_jll       <- Contains python code, notebooks and ML assets related to one ML project. 
│   │
...
and [ML asset config guide](mlops_stacks_jll/assets/README.md) to propose, test, and deploy changes to production ML code (e.g. update model parameters)
...
| Data Scientist                | Modify production model ML assets, e.g. model training or inference jobs  | [ML asset config guide](mlops_stacks_jll/assets/README.md)                                                     |
