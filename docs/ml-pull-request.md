...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_stacks_jll-run-tests-fs.yml) 
...
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/mlops_stacks_jll/mlops_stacks_jll-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/mlops_stacks_jll/mlops_stacks_jll-model)
. 
