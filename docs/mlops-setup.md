...
[ML Config](../mlops_stacks_jll/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore mlops_stacks_jll/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [mlops_stacks_jll/databricks.yml](../mlops_stacks_jll/databricks.yml)
and [mlops_stacks_jll/assets/ml-artifacts-asset.yml](../mlops_stacks_jll/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [mlops_stacks_jll/assets/README.md](../mlops_stacks_jll/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../mlops_stacks_jll/assets/README.md)  to propose, test, and deploy
