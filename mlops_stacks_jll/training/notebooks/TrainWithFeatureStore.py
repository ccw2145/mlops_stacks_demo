...
# ``mlops_stacks_jll/assets/model-workflow-asset.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_stacks_jll-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.mlops_stacks_jll.mlops_stacks_jll-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_stacks_jll.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_stacks_jll.trip_dropoff_features",
