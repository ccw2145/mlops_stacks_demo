...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``mlops_stacks_jll/assets/model-workflow-asset.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops_stacks_jll/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops_stacks_jll/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-mlops_stacks_jll-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.mlops_stacks_jll.mlops_stacks_jll-model", "Full (Three-Level) Model Name")
